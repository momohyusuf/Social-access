...
const Settings = () => {
  ...
  return (
    <section className="container mx-auto flex flex-col md:flex-row my-10 gap-10">
      <div className="md:w-2/5 card shadow-md rounded-lg p-4 border bg-white  border-gray-200 border-solid h-fit">
      ...
      <div className="md:w-3/5 card shadow-md rounded-lg p-4 border  border-gray-200 border-solid">
        <h1>Update links</h1>
        <UpdateProfile />
      </div>
    </section>
